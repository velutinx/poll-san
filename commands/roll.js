...
module.exports = {
    ...
    async execute(interaction) {
        // Check if user has permission (optional - remove if anyone can use)
        ...
        try {
            ...
            try {
                ...
                // User might have left or not found
            ...
            // Optional: Mark the giveaway as ended after rolling
            // Uncomment if you want the giveaway to end when rolled
            /*
            await db.query(
